...
// Programa para criacao de registro de candidato
...
begin
  ...
  nome:=upcase(nome);
    ...
    //INSERIR DE TRAZ PARA FRENTE, uma vez que todos as informações lida, o total de caracteres
