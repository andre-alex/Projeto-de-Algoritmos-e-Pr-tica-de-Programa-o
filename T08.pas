...
// Programa para apresentar no console a ordenacao dos candidatos por determinados criterios
...
orde,i,e,clinha,cargant,x,tot,a,posi:integer; 
...
Begin
  ...
  repeat                   // montagem do vetor conforme criterio escolhido
    a:=a+1;
    vet[a].pf:=posi;
    read(arq,reg);
